      ...
      <Paper elevation={3} sx={{ p: 4 }}>
        ...
        <Box sx={{ mb: 2, p: 1, backgroundColor: '#f5f5f5', borderRadius: 1 }}>
          <Typography variant="body2" color="textSecondary">
            Data loaded: {fruits.length} fruits, {locations.length} locations
            {staffLocationId && `, Staff location ID: ${staffLocationId}`}
            {staffLocation && `, Staff location: ${getLocationDisplayName(staffLocation)}`}
          </Typography>
        </Box>
