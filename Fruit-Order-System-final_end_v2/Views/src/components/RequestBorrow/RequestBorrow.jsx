    ...
    <Box sx={{ p: 3, maxWidth: 900, margin: '0 auto' }}>
      <Paper sx={{ 
        ...
        <Box sx={{ 
          ...
          <Typography variant="h4" gutterBottom sx={{ fontWeight: 700, mb: 0.5, color: 'white' }}>
        ...
        <CardContent sx={{ p: 4 }}>
          ...
          {staffInfo && (
            <Alert 
              ...
              icon={<Store />}
            >
              <Typography variant="body1" fontWeight="bold" align="left" color="text.primary">
                  ...
                  {fruitOptions.map(fruit => (
                    <MenuItem key={fruit.id} value={fruit.id}>
                      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                        <Box>
                          <Typography color="text.primary">{fruit.name}</Typography>
          ...
          {(formData.fromShopId || formData.toShopId || formData.fruitId) && !shopMatchError && (
            <Paper sx={{ mt: 4, p: 3, bgcolor: 'background.paper', borderRadius: 2, borderColor: 'divider' }}>
